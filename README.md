...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/VietnamHub/VideoPlayerTG)

## Deploy to Railway
<p><a href=https://github.com/VietnamHub/VideoPlayerTG/issues/7> <img src="https://img.shields.io/badge/Deploy%20To%20Railway-blueviolet?style=for-the-badge&logo=railway" width="200""/></a></p>

 
## Deploy to VPS

```sh
git clone https://github.com/gimsuri69/VideoPlayerTG
cd VCPlayerBot
